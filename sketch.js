...
function setup() {
	...
	mango1 = new Mango(940,430,60);
	mango2 = new Mango(900,340,60);
	mango3 = new Mango(1040,310,60);
	mango4 = new Mango(930,300,60);
	mango5 = new Mango(1010,420,60);
	ground = new Ground(600,660,1200,20);
	stone = new Stone(115,530,70);
